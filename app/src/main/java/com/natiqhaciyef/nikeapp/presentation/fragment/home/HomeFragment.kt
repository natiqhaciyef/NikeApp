...
import com.natiqhaciyef.nikeapp.data.model.CategoryList
...
class HomeFragment : Fragment() {
    ...
    private var postList = mutableListOf(
        ...
        PostModel(3,"Air Jordan 7 Retro","nike_air_jordan_7_retro_q" ,150),
        ...
        PostModel(8,"Air Dunk High Retro","nike_dunk_high_retro_yellow" ,85),
